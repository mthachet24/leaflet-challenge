...
// // make an AJAX call that retrieves our earthquake geoJSON data (1 month_4.5 data)
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_month.geojson").then(function(data) {


  // take coordinates and mag from json - the earthquake file above
  // We pass the magnitude of the earthquake into two separate functions
  // this is to get the color and radius.
